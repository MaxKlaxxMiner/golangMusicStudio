...
console.log("worklet-module: init go wasm");
    ...
    if (!globalThis.TextDecoder) {
        ...
        globalThis.TextDecoder.prototype.decode = function (octets) {
            if (octets instanceof DataView) {
                octets = new Uint8Array(octets.buffer, octets.byteOffset, octets.byteLength);
            }
            let string = "";
            let i = 0;
            ...
            this.importObject = {
                go: {
                    ...
                    "runtime.scheduleTimeoutEvent": (sp) => {
                        ...
                        console.log("worklet-module: sleep?")
...
console.log("worklet-module: start processor");
...
console.log("worklet-module: register");

registerProcessor("worklet-module", RandomNoiseProcessor);

console.log("worklet-module: ok.");
