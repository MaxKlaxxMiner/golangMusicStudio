...
declare class Go {
    ...
    run(instance: WebAssembly.Instance): Promise<Response>
}
...
function updateStat() {
    ...
    if (!wg.userInput) return msg("wait for first user input...");
    ...
    if (el) el.innerText = baseOctave.toString();
}
